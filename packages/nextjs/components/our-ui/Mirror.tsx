...
const Mirror: React.FC = () => {
  ...
  return (
    <div className="min-h-screen min-w-screen flex flex-col items-center">
      <div className="bg-slate-300 flex items-center min-h-[66.67vh] w-2/3">
        ...
        <div className="w-2/3 flex justify-center items-center">
          <div className="bg-slate-500 rounded-full h-[500px] w-[500px] flex justify-center items-center p-10">
      ...
      <div className="h-1/3 ">
        ...
        <div className="flex gap-16 w-full justify-center">
          ...
          <div className="flex flex-col gap-5">
            <p>price: your life</p>
            <button className="w-full py-2 bg-yellow-500 hover:scale-105 active:scale-95 hover:bg-yellow-600 duration-200 shadow-lg">
              Exit
            </button>
          </div>
        </div>

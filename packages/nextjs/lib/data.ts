...
export const DIALOGUE: DialogueOption[] = [
  dialogue(
    ...
    [
      response(
        "Uhh...yeah of course I remember you! how can I forget my good friend fart? How you been?",
        "Oh you know just killin, er I mean chillin.",
      ), // [what user responds with, what rekifar says back]
      response("I don’t know you.", "Ahaha you always were a funny guy!"),
      response("Duuhhhhh...", "Are you doin alright there buddy?"),
      response("Ser can I please suck your penis?", "Uhhh...no thank you."),
  ...
  dialogue(
    ...
    [
      response(
        "Yeah i was the one who revived her she had a ray gun",
        "Oh nice! Good save! That’s such a you thing to do!",
      ),
      response("I literally don’t know you.", "Hahaha keep on being you bro. It never gets old"),
      response(
        "Duhhhh...derrrrrr...",
        "Did you hit your head at the milady rave there dummy? You stupid fucking idiot?",
      ),
      response(
        "Every time I look at you, I feel as though i have died and come back to life. My heart burns with passion.",
  ...
  dialogue(
    ...
    [
      ...
      response("*Drools with insatiable lust*", "Uhhh are trying to have sex with me?"),
    ],
  ),
  ...
  dialogue(
    ...
    [
      response("Fuck yeah bro. I want it please gimme the hat I need it bro please.", "Relax friend I got you"),
      response("What...what the fuck are you talking about?", "Come on I know you want one just come take a look."),
      response("duhhhh hat make ears warm. Me like hat.", "That's right dummy these hats will keep your ears warm."),
      response(
        "*Has sex with Rekcifart*",
